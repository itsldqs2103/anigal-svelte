        ...
        {#each randomTags as tag (tag.tag_id)}
            <div class="group bg-base-300 rounded-base p-4">
                {#if tag.created_at === tag.updated_at}
                    <div
                        class="btn btn-primary h-6! text-sm! pointer-events-none mb-1"
                    >
                        {$i18n.t("translate.new")}!
                    </div>
                {:else}
                    <div
                        class="btn btn-warning h-6! text-sm! pointer-events-none mb-1"
                    >
            ...
            <div class="relative">
                ...
                >
                    <img
                        ...
                        onload={() =>
                            handleImageLoad(`random-${image.image_id}`)}
                    />
                </Lazy>
                ...
                {#if loadedImages[`random-${image.image_id}`]}
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <div
                                    use:tooltip={$i18n.t("translate.viewimage")}
                                >
                                    <button
                                        type="button"
                                        tabindex="-1"
                                    ...
                                    >
                                        <Eye
                                            class="inline aspect-square h-4 w-4"
                                        />
                                    </button>
                                </div>
                                <div
                                    use:tooltip={$i18n.t("translate.download")}
                                >
                                    <a
                                ...
                                {#if image.image_source}
                                    ...
                                    <div
                                        use:tooltip={$i18n.t("translate.share")}
                                    >
                                        <button
                                            type="button"
                                            tabindex="-1"
            ...
            <div class="relative">
                ...
                >
                    <img
                        ...
                        class="rounded-base object-cover"
                        onload={() =>
                            handleImageLoad(`image-${image.image_id}`)}
                    />
                </Lazy>
