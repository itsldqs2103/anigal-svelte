...
class LoginRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'password' => ['required', 'string', 'max:255', Password::min(8)->mixedCase()->numbers()->symbols()->uncompromised()],
        ];
    }
    ...
    {
        return [
            'login' => Str::lower(__('translate.email').' '.__('translate.or').' '.__('translate.username')),
